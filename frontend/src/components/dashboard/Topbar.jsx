              ...
              <div className="py-1">
                {(user?.role === "admin" || user?.role === "super_admin") && (
                  <button
                    ...
                    className="flex w-full items-center gap-2.5 rounded-xl px-3 py-2 text-xs font-bold text-blue-600 dark:text-blue-400 bg-blue-50/80 dark:bg-blue-950/50 hover:bg-blue-100 dark:hover:bg-blue-900/60 transition-colors mb-1"
                  >

...
const AuthLayout = ({ children }) => {
  ...
  // Exposed to LoginForm/RegisterForm via context so they can trigger a
  // reaction right at the point they already know the submit outcome.
  const characterApi = {
  ...
  return (
    <div className="flex min-h-screen w-full bg-slate-50">
      {/* Left panel — hidden on mobile. Back to the richer, more saturated blue. */}
      ...
      {/* Right panel — the auth card. Wrapped in the character context so any
          form here can call reactCorrect()/reactWrong(). */}
